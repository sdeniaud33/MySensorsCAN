// -----
// MsCAN_OneButton.h - Library for detecting button clicks, doubleclicks and long press pattern on a single button.
...
#ifndef MsCAN_OneButton_h
#define MsCAN_OneButton_h

#include "Arduino.h"
#include "MsCAN_OneButtonListener.h"

class MsCAN_OneButton
{
public:
  // ----- Constructor -----
  MsCAN_OneButton(MsCAN_OneButtonListener *listener, int pin, int active);
...
private:
  MsCAN_OneButtonListener *_listener;
